...
# Automatically add virtual environment's Scripts/bin directory to PATH so that subprocesses can find 'uv'
...
from .routers import analysis_router, crawler_router, data_router, websocket_router
...
async def serve_analysis_dashboard():
    """Serve the standalone AI analysis dashboard without replacing the crawler UI."""
    ...
    return {"message": "Analysis dashboard not found"}
...
async def check_environment():
    ...
    try:
        # Use the project-local uv runtime, matching start.ps1 and crawler jobs.
