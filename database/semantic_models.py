...
class SemanticAnalysisRunModel(Base):
    ...
    eligible_comments = Column(Integer, nullable=False, default=0)
    excluded_comments = Column(Integer, nullable=False, default=0)
    embedded_comments = Column(Integer, nullable=False, default=0)
    embedding_failed_comments = Column(Integer, nullable=False, default=0)
    ...
    clustering_input_comments = Column(Integer, nullable=False, default=0)
    clustering_failed_comments = Column(Integer, nullable=False, default=0)
