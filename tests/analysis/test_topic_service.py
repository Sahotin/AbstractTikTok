...
async def test_embedding_snapshot_to_topics_integration(phase1b_context, semantic_repository) -> None:
    ...
    assert completed.clustering_input_comments == completed.clustered_comments + completed.noise_comments + completed.clustering_failed_comments
    assert completed.embedded_comments >= completed.clustering_input_comments
...
async def test_quality_gate_persists_excluded_membership(phase1b_context, semantic_repository) -> None:
    ...
    assert completed.clustering_input_comments == completed.clustered_comments + completed.noise_comments + completed.clustering_failed_comments
    assert completed.embedded_comments + 1 == len(comments)
